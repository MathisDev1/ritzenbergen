...
<head>
  ...
  <?php
    ...
    <link rel="stylesheet" href="./bildschau/css/style.css">
    <link rel="stylesheet" href="./bildschau/css/kommentarOptik.css">
    <link rel="stylesheet" href="./bildschau/js-scripts/lazyloading.css">
    <script src="./bildschau/js-scripts/getURLData.js"></script>
...
<div id="handy-warnung" style="display: none;">
  ...
  <script>
    ...
    <script src="./bildschau/main.js"></script>
</section>
