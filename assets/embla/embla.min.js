!(function (n, e) {
  ...
  function g(n, e, t, r, c, s, d, f, l, p, g, m, v, h, x) {
    var y = n.scroll,
      b = n.cross,
    ...
    function z(n) {
      if (!(k = "mousedown" === n.type) || 0 === n.button) {
        var e,
          ...
          i = u(r.get(), d.get()) >= 2,
          a = k || !i,
          c = ((e = n.target), (o = e.nodeName || ""), !(w.indexOf(o) > -1)),
          f = i || (k && c);
        (B = !0),
          s.pointerDown(n),
          E.set(r),
    ...
    function O(n) {
      if (!I && !k) {
        ...
        var t = s.readPoint(n, y).get(),
          o = s.readPoint(n, b).get(),
          i = u(t, M.get()),
          a = u(o, S.get());
        if (!(I = i > a) && !L) return N();
      }
      var c = s.pointerMove(n);
      !L && c && (L = !0), f.start(), r.add(e.applyTo(c)), n.preventDefault();
    }
    function N() {
      var n = g.byDistance(0, !1).index !== m.get(),
        t = s.pointerUp() * (c ? D : C)[k ? "mouse" : "touch"],
        o = (function (n, e) {
          var t = m.clone().add(-1 * a(n)),
            r = t.get() === m.min || t.get() === m.max,
            o = g.byDistance(n, !c).distance;
          return c || Math.abs(n) < 20
            ? o
            : !h && r
            ? 0.6 * o
            : x && e
            ? 0.5 * o
            : g.byIndex(t.get(), 0).distance;
        })(e.applyTo(t), n),
        i = (function (n, e) {
          if (0 === n || 0 === e) return 0;
    ...
    var v = {
      ...
      seek: function (e) {
        ...
        var t,
          r,
          o,
          i = ((t = d.get()), (o = 0) + ((t - (r = 0)) / (100 - r)) * (l - o));
        return (
          (f = a(d.get())),
          d.normalize().multiply(i).subtract(c),
          (function (n) {
            n.divide(p), s.add(n);
          })(d),
          v
  ...
  function h(n, e, r, o, i) {
    var a = t(-e + n, r[0]),
      u = o.map(a.constrain);
    return {
      snapsContained: (function () {
        if (e <= n) return [a.max];
        if ("keepSnaps" === i) return u;
        var r = (function () {
            var n = u[0],
              e = d(u),
              r = u.lastIndexOf(n),
  ...
  function x(n, e, r, o, i) {
    var a = t(r.min + e.measure(0.1), r.max + e.measure(0.1)),
      u = a.reachedMin,
      c = a.reachedMax;
    return {
      loop: function (e) {
  ...
  function w(n, e, t, r, o) {
    ...
    return {
      byDistance: function (t, r) {
        ...
        return !r || p
          ? { index: f, distance: t }
          : { index: f, distance: t + s(e[f] - l, 0) };
      },
      byIndex: function (n, t) {
        return { index: n, distance: s(e[n] - o.get(), t) };
      },
      shortcut: s,
    };
  }
  function M(n, e, t, r, o, i, a, u) {
    var c,
      d = s(r),
      f = s(r).reverse(),
      l = ((c = o[0] - 1), m(g(f, c), "end")).concat(
        (function () {
          var n = e - o[0] - 1;
      ...
      loop: function () {
        l.forEach(function (e) {
          var t = e.getTarget,
            ...
            o = e.index,
            i = t();
          i !== r && ((u[o].style[n.startEdge] = i + "%"), (e.location = i));
        });
      },
      loopPoints: l,
    };
  ...
  function S(n, e, t) {
    ...
    return {
      addActivationEvents: function (n) {
        r.add(document, "keydown", u, !1), n.forEach(c);
      },
      removeAllEvents: i,
    };
  }
  ...
  function A(n, o, a, u, c) {
    var l,
      ...
      V =
        ...
        {
          measure: function (n) {
            return 0 === l ? 0 : (n / l) * 100;
          },
          totalPercent: 100,
        }),
      H = V.totalPercent,
      R = e(p, H),
      j = (function (n, e, t, r, o) {
        var i = n.measureSize,
          a = n.startEdge,
          u = n.endEdge,
          c = r.map(i);
        return {
          ...
          slideSizesWithGaps: r
            .map(function (n, e, r) {
              var i = e === f(r),
                s = window.getComputedStyle(d(t)),
                l = parseFloat(s.getPropertyValue("margin-" + u));
      ...
      G = j.slideSizes,
      q = j.slideSizesWithGaps,
      W = b(U, R, V, O, N, L),
      X = W.snaps,
      J = W.snapsAligned,
      Y = -d(X) + d(q),
      K = h(H, Y, X, J, z).snapsContained,
      Q = !P && "" !== z ? K : J,
      Z = (function (n, e, r) {
        var o, i;
        return { limit: ((o = e[0]), (i = d(e)), t(r ? o - n : i, o)) };
      })(Y, Q, P).limit,
      $ = r(f(Q), C, P),
      _ = $.clone(),
      nn = s(a),
      en = (function (n) {
        ...
        P || dn.scrollBounds.constrain(dn.dragHandler.pointerDown()),
          dn.scrollBody.seek(on).update();
        var n = dn.scrollBody.settle(on);
        n &&
          !dn.dragHandler.pointerDown() &&
          (dn.animation.stop(), c.emit("settle")),
          n || c.emit("scroll"),
          P &&
      ...
      cn = (function (n, e, t, r, o, i) {
        function a(r) {
          var a = r.distance,
            u = r.index !== e.get();
          a && (n.start(), o.add(a)),
            u && (t.set(e.get()), e.set(r.index), i.emit("select"));
        }
        return {
      ...
      sn = (function (n, e, t, r, o, i) {
        var a = Math.min(Math.max(i, 0.01), 0.99),
      ...
      dn = {
          ...
          (function (n, e) {
            ...
            return {
              pointerDown: function (n) {
                var r = l(n, t);
                return o.set(r), u.set(r), e.measure(o.get());
              },
              ...
              pointerUp: function () {
                ...
                return (
                  u.set(n > 100 || !r ? 0 : r), (s = []), e.measure(u.get())
                );
              },
              readPoint: l,
            };
        ...
        options: u,
        scrollBody: an,
        scrollBounds: v(Z, rn, on, an),
        scrollLooper: x(Y, V, Z, rn, [rn, on]),
        scrollProgress: y(Z),
        scrollSnaps: Q,
        scrollTarget: un,
        scrollTo: cn,
        slideFocus: S(n, cn, L),
        slideLooper: M(U, H, Y, q, Q, sn, rn, a),
        slidesInView: sn,
        slideIndexes: nn,
        target: on,
        translate: E(U, F, o),
  ...
  return function (e, t) {
    var r,
      ...
      m =
        ((r = function () {
          if (y) {
            var n = u.axis.measureSize(e.getBoundingClientRect());
            M !== n && B(), f.emit("resize");
          }
        }),
        (i = 500),
        (a = 0),
        function () {
          window.clearTimeout(a), (a = window.setTimeout(r, i) || 0);
        }),
      v = B,
      h = f.on,
      x = f.off,
    ...
    function S() {
      ...
      (s = t),
        (d = Array.prototype.slice.call(s.children)),
    ...
    function E(t) {
      if (
        ...
        (w = n({}, b, c.get())),
        (u = A(e, s, d, w, f)),
        g.add(window, "resize", m),
        u.translate.to(u.location),
        (M = u.axis.measureSize(e.getBoundingClientRect())),
        w.loop)
      ) {
        if (!u.slideLooper.canLoop()) return P(), E({ loop: !1 });
        u.slideLooper.loop();
      }
      w.draggable &&
        s.offsetParent &&
        ...
        w.draggableClass && p(e, w.draggableClass),
        w.draggingClass && f.on("pointerDown", C).on("pointerUp", C)),
        d.length && u.slideFocus.addActivationEvents(d),
        w.selectedClass && (D(), f.on("select", D).on("pointerUp", D)),
        y ||
          (setTimeout(function () {
            return f.emit("init");
          }, 0),
    ...
    function C(n) {
      var t = w.draggingClass;
      "pointerDown" === n ? p(e, t) : l(e, t);
    }
    function D() {
      var n = w.selectedClass,
        e = I(!0);
    ...
    function P() {
      u.dragHandler.removeAllEvents(),
        u.slideFocus.removeAllEvents(),
        u.animation.stop(),
        g.removeAll(),
        u.translate.clear(),
        u.slideLooper.clear(),
        l(e, w.draggableClass),
        d.forEach(function (n) {
          return l(n, w.selectedClass);
        }),
        f
          .off("select", D)
          .off("pointerUp", D)
    ...
    function k(n, e, t) {
      // if(localStorage.getItem("scroll-gallery")){
        u.scrollBody.useBaseMass().useSpeed(e ? 100 : w.speed),
        y && u.scrollTo.index(n, t || 0);
    // }
    }
    function z() {
      return u.index.get();
    ...
    return (
      E(t),
      {
        canScrollNext: function () {
          return u.index.clone().add(1).get() !== z();
        },
        ...
        scrollNext: function (n) {
          k(u.index.clone().add(1).get(), !0 === n, -1);
        },
