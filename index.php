  ...
  <!-- <div id="modal-NewITEM-4">
    <div id="modal" class="modal">
      <div class="modal-content">
        ...
        <h4>Nachdem die alte Internetseite der Dorfgemeinschaft Amedorf & Ritzenbergen schon etwas aus der Zeit
          gerutscht ist,
          haben sich Jonas und Mathis Kuhlenkamp zur Aufgabe gemacht, die Website zu modernisieren. Dabei wurden viele
          Funktionen die
          schon lange nicht mehr richtig genutzt werden, wie das Gästebuch oder das früher beliebte BuLi-Tipp entfernt.
          Dafür haben die
          Anwohner jetzt eine bessere und modernere Übersicht über Veranstaltungen oder Neuigkeiten. Eine Website ist
          für unser kleines
        ...
        <div class="col-12 content-head">
          <div class="mbr-section-head mb-5">
            ...
            <h5 style="text-align: center;"><b>Amedorf-Ritzenbergen/Holtum-Marsch und Freunde</b> <br>
              ...
              Wer mitspielen möchte, der melde sich bitte spätestens bis zum 23. März verbindlich an! <br> Ein Klick
              unten genügt – bitte Namen (Vor- und Nachnamen) und Teilnehmerzahl eintragen!</h5><br>
          ...
          <form action="" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input
            ...
            <div class="row">
              <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Du hast dich erfolgreich zum
                Doppelkopfturnier angemeldet</div>
